...
async def to_code(config: dict[str, Any]) -> None:
    """Generate C++ code for Econet text sensor component.
    
    Creates a text sensor that reads string datapoint values from
    Econet devices and exposes them to Home Assistant.
